...
public class ImageDecodingInfo {
    ...
    public ImageDecodingInfo(String str, String str2, ImageSize imageSize, ViewScaleType viewScaleType2, ImageDownloader imageDownloader, DisplayImageOptions displayImageOptions) {
        this.imageKey = str;
        this.imageUri = str2;
