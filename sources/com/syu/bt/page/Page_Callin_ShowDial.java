...
public class Page_Callin_ShowDial extends Page {
    public ActBt actBt;
    ...
    public class RunnableSwitchFull implements Runnable {
        ...
        public void run() {
            if (Page_Callin_ShowDial.this.actBt.mPageCurrent != Page_Callin_ShowDial.this.getPage()) {
                return;
            }
            if (Page_Callin_ShowDial.this.actBt.isHalf()) {
                if (Page_Callin_ShowDial.this.mViewCallinFullScreen != null) {
                    Page_Callin_ShowDial.this.mViewCallinFullScreen.setVisibility(8);
                }
                if (Page_Callin_ShowDial.this.mViewCallinHalfScreen != null) {
                    Page_Callin_ShowDial.this.mViewCallinHalfScreen.setVisibility(0);
                    return;
                }
                return;
            }
            if (Page_Callin_ShowDial.this.mViewCallinHalfScreen != null) {
                Page_Callin_ShowDial.this.mViewCallinHalfScreen.setVisibility(8);
            }
            if (Page_Callin_ShowDial.this.mViewCallinFullScreen != null) {
                Page_Callin_ShowDial.this.mViewCallinFullScreen.setVisibility(0);
            }
        }
    }

    public Page_Callin_ShowDial(JPage jPage, ActBt actBt2) {
        super(jPage);
        this.actBt = actBt2;
    }
