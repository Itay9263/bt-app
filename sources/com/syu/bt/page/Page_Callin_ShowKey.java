...
public class Page_Callin_ShowKey extends Page {
    public ActBt actBt;
    ...
    public class RunnableSwitchFull implements Runnable {
        ...
        public void run() {
            if (Page_Callin_ShowKey.this.actBt.mPageCurrent != Page_Callin_ShowKey.this.getPage()) {
                return;
            }
            if (Page_Callin_ShowKey.this.actBt.isHalf()) {
                if (Page_Callin_ShowKey.this.mViewCallinFullScreen != null) {
                    Page_Callin_ShowKey.this.mViewCallinFullScreen.setVisibility(8);
                }
                if (Page_Callin_ShowKey.this.mViewCallinHalfScreen != null) {
                    Page_Callin_ShowKey.this.mViewCallinHalfScreen.setVisibility(0);
                    return;
                }
                return;
            }
            if (Page_Callin_ShowKey.this.mViewCallinHalfScreen != null) {
                Page_Callin_ShowKey.this.mViewCallinHalfScreen.setVisibility(8);
            }
            if (Page_Callin_ShowKey.this.mViewCallinFullScreen != null) {
                Page_Callin_ShowKey.this.mViewCallinFullScreen.setVisibility(0);
            }
            Page_Callin_ShowKey.this.page_Callin = (Page_Callin) Page_Callin_ShowKey.this.actBt.mPageCurrent.getNotify();
            switch (Bt.DATA[9]) {
                case 3:
                    if (!App.bShowKeyFlag && Page_Callin_ShowKey.this.page_Callin != null) {
                        Page_Callin_ShowKey.this.page_Callin.Switch2Keyboard(1);
                        break;
                    }
                case 4:
                    if (!App.bShowKeyFlag && Page_Callin_ShowKey.this.page_Callin != null) {
                        Page_Callin_ShowKey.this.page_Callin.Switch2Keyboard(2);
                        break;
                    }
                case 5:
                    if (!App.bShowKeyFlag && Page_Callin_ShowKey.this.page_Callin != null) {
                        Page_Callin_ShowKey.this.page_Callin.Switch2Keyboard(3);
                        break;
                    }
            }
            if (App.bShowKeyFlag && Page_Callin_ShowKey.this.page_Callin != null) {
                Page_Callin_ShowKey.this.page_Callin.Switch2Keyboard(4);
            }
        }
    }

    public Page_Callin_ShowKey(JPage jPage, ActBt actBt2) {
        super(jPage);
        this.actBt = actBt2;
    }
    ...
    private boolean btnClick(android.view.View r6) {
        ...
        L_0x00f9:
            ...
            goto L_0x000b
        */
        throw new UnsupportedOperationException("Method not decompiled: com.syu.bt.page.Page_Callin_ShowKey.btnClick(android.view.View):boolean");
    }
