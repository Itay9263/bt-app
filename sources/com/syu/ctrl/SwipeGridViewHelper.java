...
public class SwipeGridViewHelper {
    JGridView gridView;
        ...
        public void run() {
            if (this.view != null) {
                ...
                if (this.bRun && this.view != null) {
                    ...
                    SwipeGridViewHelper.this.gridView.invalidate();
                    if (!z) {
    ...
    public SwipeGridViewHelper(JGridView jGridView, int i) {
    ...
    private boolean isHitCurItemLeft(float f) {
        return f < ((float) (this.gridView.getWidth() - this.mRightViewWidth));
    }
    ...
    public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        switch (motionEvent.getAction()) {
            case 0:
                ...
                this.mFirstX = x;
                this.mFirstY = y;
                int pointToPosition = this.gridView.pointToPosition((int) this.mFirstX, (int) this.mFirstY);
                if (pointToPosition >= 0) {
                    View childAt = this.gridView.getChildAt(pointToPosition - this.gridView.getFirstVisiblePosition());
        ...
        switch (motionEvent.getAction()) {
            ...
            case 3:
                ...
                if (this.mIsHorizontal != null && this.mIsHorizontal.booleanValue()) {
                    ...
                    this.gridView.superTouchEvent(motionEvent);
                    return true;
                }
            case 2:
                ...
                if (this.mIsHorizontal != null || judgeScrollDirection(f, f2)) {
                    if (!this.mIsHorizontal.booleanValue()) {
                        ...
                        if (f >= 0.0f || f <= ((float) (-this.mRightViewWidth)) || this.mCurrentItemView == null) {
                            return true;
                        }
