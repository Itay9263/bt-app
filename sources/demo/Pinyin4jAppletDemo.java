...
public class Pinyin4jAppletDemo extends JApplet {
    private static final Dimension APP_SIZE = new Dimension(FinalTpms.U_CNT_MAX, 400);
        ...
        if (this.convertButton == null) {
            ...
            this.convertButton.addActionListener(new ActionListener(this) {
                ...
                private void updateUnformattedTextField(char c) {
                    Pinyin4jAppletDemo.access$400(this.this$0).setText(concatPinyinStringArray(ci.a(c)));
                    Pinyin4jAppletDemo.access$500(this.this$0).setText(concatPinyinStringArray(ci.b(c)));
                    Pinyin4jAppletDemo.access$600(this.this$0).setText(concatPinyinStringArray(ci.c(c)));
                    Pinyin4jAppletDemo.access$700(this.this$0).setText(concatPinyinStringArray(ci.d(c)));
                    Pinyin4jAppletDemo.access$800(this.this$0).setText(concatPinyinStringArray(ci.e(c)));
                    Pinyin4jAppletDemo.access$900(this.this$0).setText(concatPinyinStringArray(ci.f(c)));
                }
